...
def level_3_1_slovar():
    if "Клинок Эльфов" in inventory:
        print("Закончив неравный бой, вы решили вернуться в гильлию за наградой")
        print("Вдруг на вас упал огромный камень, это фиаско")
        exit()
    elif "Меч из железной брони" in inventory:
        print("\nНемного отдохнув вы двинулись обратно в гильдию за наградой")
        print("\n Подойдя к сотруднику гильдии за наградой, он спросил ваше имя:")
        hero_name["name"] = input("Как же вас зовут?:")
        print(f"\n(Сотрудник гильдии): Багодарим вас за выполнения задания, уважаемый {hero_name['name']}, вот ваша награда {inventory.append("Жетон убийцы кобальтов")} ")
    print("Конец акта 1")
    exit()
Game()